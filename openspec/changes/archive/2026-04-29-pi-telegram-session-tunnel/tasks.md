...
- [x] 10.4 Add integration-style tests that exercise local + remote coexistence, broker route synchronization, post-pairing local prompt submission, skill invocation after pairing, and recovery after disconnect/reconnect.
