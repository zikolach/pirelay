# relay-skill-invocation Specification

## Purpose
Defines safe remote skill discovery and invocation semantics for authorized messenger users, including allow-list configuration, command parsing, prompt delivery, audit trails, broker parity, and secret-safe output boundaries.
## Requirements
