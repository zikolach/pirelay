# relay-route-action-safety Specification

## Purpose
Defines shared route availability probes, typed route-action outcomes, operation rollback semantics, and adapter/broker integration rules for fallible Pi route actions after messenger authorization and binding selection.
