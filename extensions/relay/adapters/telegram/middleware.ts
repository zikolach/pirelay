import type { ChannelInboundEvent } from "../../core/channel-adapter.js";
import { telegramCapabilities, telegramUpdateToChannelEvent } from "./adapter.js";
import { parseTelegramActionCallbackData, type TelegramActionCallback } from "./actions.js";
import type { TelegramInboundCallback, TelegramInboundMessage, TelegramInboundUpdate, TelegramTunnelConfig } from "../../core/types.js";
import { parseTelegramCommand } from "../../core/utils.js";
import {
  createRelayPipeline,
