...
const formatSkillOutcome = requiredFunction(skillInvocationModule, './skill-invocation.ts', 'formatSkillOutcome');
const invokeRemoteSkill = requiredFunction(skillInvocationModule, './skill-invocation.ts', 'invokeRemoteSkill');
