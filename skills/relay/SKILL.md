...
Use `/new` only for the selected online idle route. It starts a replacement Pi session and safely moves eligible relay control to it; it does not start an offline Pi process, and busy or unsupported routes refuse with guidance.
